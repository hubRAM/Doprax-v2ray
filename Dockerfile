...
ENV UUID e4cbef6f-c906-45da-8318-1cb874368724
ENV VMESS_WSPATH /data/config/vmess
ENV VLESS_WSPATH /data/config/vless

COPY supervisord.conf /etc/supervisor/conf.d/supervisord.conf
COPY nginx.conf /etc/nginx/nginx.confe4cbef6f-c906-45da-8318-1cb874368724
